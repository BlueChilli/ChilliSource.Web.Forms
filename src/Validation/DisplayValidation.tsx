...
const validationsUnused = (
	validationsUsed: InputTest[],
	validationsAvailable: InputTest[],
	isSwitch: boolean
): InputTest[] => {
...
class DisplayValidation extends React.Component<
	PerformanceWrapperProps & DisplayValidationProps,
	undefined
> {
	render() {
