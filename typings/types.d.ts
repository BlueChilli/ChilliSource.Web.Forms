...
export type compareAdditionalProps = <TProps>(
  props: TProps,
  nextProps: TProps
) => boolean;
...
export type SetInputInteractionAction = FSA<
  SetInputInteractionPayload,
  "SET_INPUT_INTERACTION"
>;
...
export type ClearAllInputsAction = FSA<
  ClearAllInputsPayload,
  "CLEAR_ALL_INPUTS"
>;
...
export type BasicReducer = {
  ...
  SET_INPUT_INTERACTION: ReducerFunc<
    Map<string, any>,
    SetInputInteractionAction
  >;
  SET_ALL_INPUT_INTERACTIONS: ReducerFunc<
    Map<string, any>,
    SetAllInputInteractionAction
  >;
...
export interface SetInputInteractionPayload
  extends SetAllInputInteractionPayload {
  inputName: string[];
}

export interface InputBlurred
  extends NameProp,
    NameSpaceProp,
    IdProp,
...
export interface PerformanceWrapperUncalledValidationHelpers {
  ...
  compareAdditionalProps: (
    props: AdditionalCompareProps
  ) => compareAdditionalProps;
}
...
export interface PerformanceWrapperWithHandlers
  extends PerformanceWrapperInputHelpers {}
